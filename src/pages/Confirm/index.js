...
export default function Confirm() {
    ...
    async function validarMail(e) {
        ...
        await api.post('validar/email', data, {
        }).then(response => {
        ...
        <div>
            <div className="login-box">
                ...
                <div className="login-box-body">
                    ...
                    <p className="login-box-msg"><b>{email}</b></p>
                    <div className="form-group has-feedback">
                        <input value={mail} onChange={e => setMail(e.target.value)} type="email" className="form-control" style={{ fontWeight: 'bold' }} />
                    </div>
                    ...
                    <div className="row">
                        ...
                        <button onClick={validarMail} className="btn btn-primary btn-block btn-flat" style={{ fontFamily: "Open Sans,sans-serif" }} >Validar</button>
                    </div>
                </div>
                </div>
