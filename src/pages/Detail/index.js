        ...
        <div>
            <header className="top">
                <a href="#" onClick={DropMenu}>
                    ...
                    <span id="nome_cliente" className="hidden-xs">LUCAS GONCALVES DE ARAUJO ROBERTO</span>
                </a>
            </header>
            <div className="dropmenu" id="myDropdown">
                <div className="dropmenu-btn">
                    <img src={LogoUser} className="image-drop" alt="Image DropMenu"/>
                    <span className="hidden-large" >LUCAS GONCALVES DE ARAUJO ROBERTO</span>
                </div>
                <div className="pull-right btn-detail">
                    <button onClick={handleExit}  className="btn btn-default btn-flat">Sair</button>
                </div>
            </div>
            ...
            <h2 className="h2-size">
                Bem vindo ao Portal de Sinistros Santander.
            </h2>
            ...
            <div className="row-detail">
                <div className="form-group col-md-4">
                    ...
                    <input type="text" value={nomeSegurado} className="form-control" readOnly={true}/>
                </div>
            <div className="form-group col-md-4">
                    <label >Nome do Sinistrado</label>
                    <input type="text" value={nomeSinistrado} className="form-control" readOnly={true}/>
                </div>
            <div className="form-group col-md-4">
                    <label >Nome do Notificante</label>
                    <input type="text" value={nomeNotificante} className="form-control" readOnly={true}/>
                </div>
            </div>
            ...
            <div className="row-detail">
                <div className="form-group col-md-3">
                    ...
                    <input type="text" value={cpfSegurado} className="form-control" readOnly={true}/>
                </div>
            <div className="form-group col-md-3">
                    <label>CPF Sinistrado</label>
                    <input type="text" value={cpfSinistrado} className="form-control" readOnly={true}/>
                </div>
            <div className="form-group col-md-3">
                    <label>CPF Notificante</label>
                    <input type="text" value={cpfNotificante} className="form-control" readOnly={true}/>
                </div>
                <div className="form-group col-md-3">
                    <label>Nº Sinistro</label>
                    <input type="text" value={numSinistro} className="form-control" readOnly={true}/>
                </div>
            </div>

            <div className="row-detail">
                <div className="form-group col-md-3">
                    <label>E-mail <span style={{ color: 'red', fontSize: 14 }}>*</span></label>
                    <input type="email" value={email} className="form-control" readOnly={true}/>
                </div>
                <div className="form-group col-md-3">
                    <label>Telefone Contato <span style={{ color: 'red', fontSize: 14 }}>*</span></label>
                    <input type="text" value={telefone} className="form-control" readOnly={true}/>
                </div>
                <div className="form-group col-md-3">
                        <label>Cobertura Reclamada</label>
                        <input type="text" value={cobertura} className="form-control" readOnly={true}/>
                </div>
                <div className="form-group col-md-3">
                    <label>Apolice</label>
                    <input type="text" value={apolice} className="form-control" readOnly={true}/>
                </div>
            </div>
